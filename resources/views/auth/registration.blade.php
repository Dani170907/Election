<x-layout>
    <div class="flex items-center justify-center min-h-screen px-4 bg-gray-100 sm:px-6 lg:px-8" style="background-image: url('{{ asset('image/bg.png') }}');
                ...
                <div class="flex space-x-3">
                    <div class="w-1/2 form-control">
                        ...
                        <div class="flex items-center h-10 gap-2 bg-white bg-opacity-50 input input-bordered backdrop-blur-sm">
                            ...
                            <input type="text" class="text-sm bg-transparent grow" name="name" id="name" required placeholder="Nama Lengkap" value="{{ old('name') }}" />
                        </div>
                        @error('name')
                    ...
                    <div class="w-1/2 form-control">
                        ...
                        <div class="flex items-center h-10 gap-2 bg-white bg-opacity-50 input input-bordered backdrop-blur-sm">
                            ...
                            <input type="text" class="text-sm bg-transparent grow" name="nis" id="nis" required placeholder="Nomor Induk" value="{{ old('nis') }}" />
                        </div>
                        @error('nis')
                        <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                        @enderror
                ...
                <div class="flex space-x-3">
                    <div class="w-1/2 form-control">
                        ...
                        <div class="flex items-center h-10 gap-2 bg-white bg-opacity-50 input input-bordered backdrop-blur-sm">
                            ...
                            <input type="password" class="text-sm bg-transparent grow" name="password" id="password" required placeholder="Password" />
                        </div>
                        @error('password')
                        <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="w-1/2 form-control">
                        ...
                        <div class="flex items-center h-10 gap-2 bg-white bg-opacity-50 input input-bordered backdrop-blur-sm">
                            ...
                            <input type="password" class="text-sm bg-transparent grow" name="password_confirmation" id="password_confirmation" required placeholder="Konfirmasi" />
                        </div>
                    </div>
                </div>
