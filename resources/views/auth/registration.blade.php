            ...
            <div class="w-full max-w-md p-6 space-y-4 bg-white rounded-lg shadow-md">
                ...
                <form action="{{ route('register.post') }}" method="post" class="space-y-3">
                    ...
                    <div class="form-control">
                        ...
                        <label class="flex items-center h-10 gap-2 input input-bordered">
                            ...
                            <input
                                ...
                                id="nis"
                                required
                                placeholder="format NIS '12.3456'"
                                value="{{ old('nis') }}"
                            />
                        </label>
                        @error('nis')
                    ...
                    <div class="mt-4 form-control">
                        <button
                            type="submit"
                            class="w-full text-sm transition duration-300 ease-in-out btn btn-primary hover:opacity-90"
                        >
                            {{ __('Daftar') }}
                        </button>
                    </div>
                    ...
                    <div class="mt-2 text-xs text-center text-gray-600">
                        ...
                        <a
                            href="{{ route('login') }}"
                            class="ml-1 font-semibold text-blue-500 hover:text-blue-600"
                        >
                            Login
                        </a>
                    </div>
