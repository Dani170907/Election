<x-layout>
    <div class="container px-4 py-4 mx-auto bg-gray-100">
        <div class="mb-8 text-center">
            ...
            <div class="py-6 mb-8 text-center text-white rounded-lg shadow-lg bg-gradient-to-r from-blue-500 to-blue-700">
                <h1 class="mb-3 text-3xl font-bold">Pilih Kandidat</h1>
                <p class="text-lg">Jangan golput! Pilihan boleh beda, tapi persatuan dan kesatuan harus kita jaga.</p>
            </div>
            @if(session('success'))
